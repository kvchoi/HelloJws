...
/**
 * {@link #jumpConsistentHash(long, int)} accepts "a 64-bit key and the number of buckets. It outputs a number in the range [0, buckets)."
 * <a href="http://arxiv.org/ftp/arxiv/papers/1406/1406.2294.pdf">Paper</a>.
 * <p>
...
public final class JumpConsistentHash {
    ...
    private static final long CONSTANT = UnsignedLongs.parseUnsignedLong("2862933555777941757");
    ...
    /**
     * Accepts "a 64-bit key and the number of buckets. It outputs a number in the range [0, buckets].". This implementation uses as a key
     * the {@link Object#hashCode()} of the supplied argument.
     *

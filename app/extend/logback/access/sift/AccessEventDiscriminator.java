...
/**
 * 
 * AccessEventDiscriminator's job is to return the value of a designated field in an {@link IAccessEvent} instance.
 * 
 * <p>
...
public class AccessEventDiscriminator extends AbstractDiscriminator<IAccessEvent> {
    ...
    private String getRequestURI(IAccessEvent acccessEvent) {
        String uri = acccessEvent.getRequestQueryString();

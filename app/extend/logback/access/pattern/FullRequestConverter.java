 ...
 */
package extend.logback.access.pattern;
 ...
 * <p>
 * It has been removed from the {@link ch.qos.logback.StatisticsLogPatternLayout.PatternLayout} since it needs further testing before wide use.
 * <p>
 * 
...
public class FullRequestConverter extends AccessConverter {
    ...
    public String convert(IAccessEvent ae) {
        ...
        buf.append(ae.getRequestQueryString());

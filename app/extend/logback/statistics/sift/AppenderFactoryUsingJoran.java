...
public class AppenderFactoryUsingJoran extends AbstractAppenderFactoryUsingJoran<IStatisticsEvent> {
  ...
  @Override
  public SiftingJoranConfiguratorBase<IStatisticsEvent> getSiftingJoranConfigurator(
      String keyValue) {

 ...
 */
package extend.logback.statistics.boolex;
...
public class JaninoEventEvaluator extends JaninoEventEvaluatorBase<IStatisticsEvent> {
  ...
  static {
    ...
    DEFAULT_PARAM_TYPE_LIST.add(IStatisticsEvent.class);
  }
  ...
  @Override
  protected Object[] getParameterValues(IStatisticsEvent accessEvent) {
